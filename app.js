import { initializeAnalytics } from "./analytics.js?v=0.3.99";
...
import { bindComplinePreference, complinePreviewMarkerAt, complinePreviewRelation, createComplineBoundaryTimer, initializeComplinePreference, refreshComplinePreview, shouldShowComplinePreview } from "./compline-preference.js?v=0.3.99";
import { bindFeastLinksPreference, initializeFeastLinks } from "./feast-link-preference.js?v=0.3.99";
import { bindNoondayPreference, createNoondayBoundaryTimer, initializeNoondayPreference, noondayPreviewMarkerAt, noondayPreviewRelation, refreshNoondayPreview, shouldShowNoondayPreview } from "./noonday-preference.js?v=0.3.99";
import { scheduledServiceAt, timedOfficePreviewToExit } from "./office-schedule.js?v=0.3.99";
import { calendarEventIconAssetPath, paintPixelArtStack } from "./pixel-art.js?v=0.3.99";
import { bindPsalmPreference, createPsalmBoundaryTimer, initializePsalmPreference, psalmOfficeAt, refreshPsalmDisplay } from "./psalm-preference.js?v=0.3.99";
import { bindPrayerReminderSettings } from "./prayer-calendar.js?v=0.3.99";
import { createReadingPackLoader, loadAroundToday, mergeReadingBundle } from "./reading-pack-loader.js?v=0.3.99";
import { initializeTheme, setThemeMode, syncSystemTheme } from "./theme.js?v=0.3.99";
import { appVersionLabel } from "./version.js?v=0.3.99";

const APP_ROOT = new URL(".", window.location.href);
const CONTENT_ROOT = APP_ROOT.pathname.endsWith("/web/") ? new URL("../", APP_ROOT) : APP_ROOT;
const PACK_URL = new URL("firmware/circuitpython/readings.active.jsonl?v=0.3.99", CONTENT_ROOT);
const PACK_INDEX_URL = new URL("firmware/circuitpython/readings.active.idx?v=0.3.99", CONTENT_ROOT);
const COLLECTS_URL = new URL("data/collects/collects.json?v=0.3.99", CONTENT_ROOT);
