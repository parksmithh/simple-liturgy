const CACHE = "daily-office-reader-v0.3.143";
...
const PACK_URL = `${CONTENT_ROOT}firmware/circuitpython/readings.active.jsonl?v=0.3.143`;
const PACK_INDEX_URL = `${CONTENT_ROOT}firmware/circuitpython/readings.active.idx?v=0.3.143`;
const COLLECTS_URL = `${CONTENT_ROOT}data/collects/collects.json?v=0.3.143`;
const RITE_TWO_URL = `${CONTENT_ROOT}data/daily-office/rite-two.json?v=0.3.143`;
const FULL_OFFICE_INDEX_URL = "./dor-engine/daily-office-content.index.json?v=0.3.143";
const FULL_OFFICE_PACK_URL = "./dor-engine/daily-office-content.active.jsonl?v=0.3.143";
...
const SHELL = [
  ...
  "./NOTICE",
  "./CONTRIBUTING.md",
  "./design-tokens.css?v=0.3.143",
  "./app.css?v=0.3.143",
  "./app.js?v=0.3.143",
  "./analytics.js?v=0.3.143",
  "./bookmark-engine.js?v=0.3.143",
  "./boundary-timer.js?v=0.3.143",
  "./compline-preference.js?v=0.3.143",
  "./daily-office-content.js?v=0.3.143",
  "./daily-office.js?v=0.3.143",
  "./feast-link-preference.js?v=0.3.143",
  "./feast-wikipedia.js?v=0.3.143",
  "./full-office-lifecycle.js?v=0.3.143",
  "./noonday-preference.js?v=0.3.143",
  "./office-schedule.js?v=0.3.143",
  "./office-document.js?v=0.3.143",
  "./pixel-art.js?v=0.3.143",
  "./prayer-calendar.js?v=0.3.143",
  "./prayer-format-preference.js?v=0.3.143",
  "./psalm-preference.js?v=0.3.143",
  "./reading-pack-loader.js?v=0.3.143",
  "./theme.js?v=0.3.143",
  "./timed-office-onboarding.js?v=0.3.143",
  "./version.js?v=0.3.143",
  "./manifest.webmanifest?v=0.3.143",
  "./icon.svg?v=0.3.143",
  "./apple-touch-icon.png?v=0.3.143",
  "./icon-192.png?v=0.3.143",
  "./icon-512.png?v=0.3.143",
