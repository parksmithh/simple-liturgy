const CACHE = "daily-office-reader-v0.3.57";
const CONTENT_ROOT = self.registration.scope.endsWith("/web/") ? "../" : "./";
const PACK_URL = `${CONTENT_ROOT}firmware/circuitpython/readings.active.jsonl?v=0.3.57`;
...
const SHELL = [
  "./",
  "./index.html",
  "./design-tokens.css?v=0.3.57",
  "./app.css?v=0.3.57",
  "./app.js?v=0.3.57",
  "./bookmark-engine.js?v=0.3.57",
  "./feast-link-preference.js?v=0.3.57",
  "./feast-wikipedia.js?v=0.3.57",
  "./pixel-art.js?v=0.3.57",
  "./psalm-preference.js?v=0.3.57",
  "./theme.js?v=0.3.57",
  "./version.js?v=0.3.57",
  "./manifest.webmanifest?v=0.3.57",
  "./icon.svg?v=0.3.57",
